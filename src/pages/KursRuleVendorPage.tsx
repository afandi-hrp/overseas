  ...
  return (
    <div className="flex-1 h-full min-h-screen overflow-y-auto pb-10 bg-gradient-to-br from-[#FFF5C5] to-[#F58C77]">
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {showForm && (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8 animate-in fade-in slide-in-from-top-4">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={handleCloseForm} className="text-[#5A305A] hover:text-[#5A305A] transition-colors">
                Tutup
              </button>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-5">
              <div>
                <label className="block text-sm font-bold text-[#5A305A] mb-1">Vendor Name <span className="text-rose-500">*</span></label>
                <input
                  type="text"
                  required
                  value={vendorName}
                ...
                />
                <p className="text-[11px] text-[#5A305A] mt-1.5 flex items-start gap-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-[#5A305A] mb-1">Jenis Kurs <span className="text-rose-500">*</span></label>
                  <select
                    value={kursType}
                ...
                <div>
                  <label className="block text-sm font-bold text-[#5A305A] mb-1">Adjustment (Rp) <span className="text-rose-500">*</span></label>
                  <input
                    type="number"
                    required
                    value={adjustment}
                    ...
                    className="w-full border border-slate-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <p className="text-[11px] text-[#5A305A] mt-1">Bisa bernilai negatif, contoh: 200 atau -150</p>
                </div>
              </div>
              
              <div>
                <label className="block text-sm font-bold text-[#5A305A] mb-1">Catatan (Opsional)</label>
                <textarea
                  value={catatan}
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="px-6 py-4 text-xs font-bold text-[#5A305A] uppercase tracking-wider">Vendor Name</th>
                  <th className="px-6 py-4 text-xs font-bold text-[#5A305A] uppercase tracking-wider w-32">Jenis Kurs</th>
                  <th className="px-6 py-4 text-xs font-bold text-[#5A305A] uppercase tracking-wider w-32">Adjustment</th>
                  <th className="px-6 py-4 text-xs font-bold text-[#5A305A] uppercase tracking-wider">Catatan</th>
                  <th className="px-6 py-4 text-xs font-bold text-[#5A305A] uppercase tracking-wider text-right w-32">Aksi</th>
                </tr>
              </thead>
        ...
        <p className="text-center text-sm text-[#5A305A] mt-6 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
