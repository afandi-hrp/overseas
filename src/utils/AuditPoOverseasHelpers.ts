...
// Daftar tetap kategori -- BEDA dari AuditPoHelpers.ts (Audit AP Local), disesuaikan user
// khusus utk konteks Overseas (2026-09). Dipilih lewat combobox searchable (ketik utk filter,
// klik utk pilih) di kolom Kategori, BUKAN free text bebas.
export const KATEGORI_OPTIONS = [
  'DOKUMEN PURCHASE ORDER',
  'DOKUMEN INVOICE',
  'DOKUMEN STOCK IN/PI',
  'DOKUMEN IMPORT CALCULATION/LOGISTIC',
  'IMPORT CALCULATION/LOGISTIC',
  'NOMOR DOKUMEN PURCHASE ORDER',
  'NOMOR DOKUMEN INVOICE',
  'NOMOR DOKUMEN STOCK IN/PI',
  'NOMOR DOKUMEN IMPORT CALCULATION/LOGISTIC',
  'DESTINATION INDONESIA',
  'NAMA VENDOR',
  'NO PO',
  'NAMA KAPAL',
  'BIAYA LOGISTIK/FREIGHT',
  'NAMA ITEM',
  'CUSTOMER NAME',
  'ADDRESS',
  'CURRENCY',
  'JUMLAH ITEM BARANG FISIK',
  'DISCOUNT',
  'OTHER/FREIGHT COST',
  'TOTAL AMOUNT',
  'SATUAN',
